...
public class Semantico implements Constants {
    ...
    private void acao01(int position) throws SemanticError {
        ...
        if ((tipo1.equals("int64") || tipo1.equals("float64")) && (tipo2.equals("int64") || tipo2.equals("float64"))) {
            ...
            throw new SemanticError("tipo(s) incompatível(is) em expressão aritmética", position);
        }
...
//        String breakLine = "\n";
    ...
    private void acao18(int position) throws SemanticError {
        ...
        if (tipo1.equals("bool") && tipo2.equals("bool")) {
            ...
            // em caso negativo, gerar exceção e mensagem de erro: tipo(s) incompatível(is) em expressão aritmética
            throw new SemanticError("tipo(s) incompatível(is) em expressão lógica", position);
        }
